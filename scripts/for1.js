//for1. js
//for(초기값; 조건식; 증감식) {조건식이 참일때 실행하는 명령}
...
for(let i=12; i>=1; i--){
    console.log(`${i}월의 탄생석은 ${stone[i-1]}입니다.`);
}
...
const md_pick_li = md_pick_ul.querySelector('li');//복사하는 자식 대상 (document 자리에 선택할 태그의 부모위치를 적어도 됨)
